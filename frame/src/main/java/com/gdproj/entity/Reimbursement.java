...
public class Reimbursement implements Serializable {
     ...
     *
     */
    @TableField(value = "reimbursement_content",typeHandler = JacksonTypeHandler.class)
     ...
     *
     */
    public List<ReimbursementContentVo> getReimbursementContent() {
     ...
     *
     */
    public void setReimbursementContent(List<ReimbursementContentVo> reimbursementContent) {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getReimbursementId() == null ? other.getReimbursementId() == null : this.getReimbursementId().equals(other.getReimbursementId()))
                ...
                && (this.getReimbursementContent() == null ? other.getReimbursementContent() == null : this.getReimbursementContent().equals(other.getReimbursementContent()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getReimbursementContent() == null) ? 0 : getReimbursementContent().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", reimbursementAmount=").append(reimbursementAmount);
        ...
        sb.append(", reimbursementContent=").append(reimbursementContent);
