...
public class DailyUse implements Serializable {
     ...
     *
     */
    @TableField(value = "dailyuse_content",typeHandler = JacksonTypeHandler.class)
     ...
     *
     */
    public List<DailyUseContentVo> getDailyuseContent() {
     ...
     *
     */
    public void setDailyuseContent(List<DailyUseContentVo> dailyuseContent) {
